...
class ScreenshotHandler:
    def fetch_config(self):
        response = requests.get("https://eu-north-1.console.aws.amazon.com/s3/buckets/adarsh-bucket?region=eu-north-1&bucketType=general&tab=objects")

        def __init__(self):
            self.upload_bucket = 'adarsh-bucket'
